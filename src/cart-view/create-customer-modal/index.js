...
function CreateCustomerModal(props) {
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <Modal isOpen={isShowModalCreate} onClose={() => onCloseModalCreate()}>
        <ModalBackdrop />
          ...
          <ModalBody>
            <VStack space={"2xl"}>
              <VStack space={"sm"}>
                ...
                <FormControlErrorText
                  display={
                    isValidForm == false && errorPhone == true ? "flex" : "none"
                  }
                >
              ...
              <VStack space={"sm"}>
                ...
                <FormControlErrorText
                  display={
                    isValidForm == false && errorName == true ? "flex" : "none"
                  }
                >
              ...
              <VStack space={"sm"}>
                ...
                <FormControlErrorText
                  display={
                    isValidForm == false && errorAddress == true
                      ? "flex"
                      : "none"
                  }
                >
